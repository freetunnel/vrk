...
echo -e "  Auther : ${green}FREE TUNNEL ® ${NC}${YELLOW}(${NC} ${green} FTP ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/freetunnel/vrk/main/"
...
clear
izinsc="https://raw.githubusercontent.com/freetunnel/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="1916636450"
KEY="6681901981:AAFalrLS-4fkb-wlDwB4p-PAfrcxNQS2VTc"
...
<code>────────────────────</code>
<b> FREE TUNNELING PROJECT  </b>
<code>────────────────────</code>
<i>Automatic Notificatication install script</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/freetunnelproject"}]]}' 
...
wget -q https://raw.githubusercontent.com/freetunnel/vrk/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
